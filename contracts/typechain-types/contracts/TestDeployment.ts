...
export interface TestDeploymentInterface extends Interface {
  getFunction(
...
export interface TestDeployment extends BaseContract {
  connect(runner?: ContractRunner | null): TestDeployment;
  waitForDeployment(): Promise<this>;

  interface: TestDeploymentInterface;
